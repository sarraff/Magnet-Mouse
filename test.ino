...
//      sum_y = sum_y + 408;
//      sum_z = sum_z - 4490;
      double tsum_x = sum_x/100 +3250;
      double tsum_y = sum_y/100 +525;
      double tsum_z = sum_z/100 -1660;
      ...
      //09Serial.print("Intensity value: ");
      //Serial.println(intensity);
//      Serial.print("\t");
      //Serial.print("Distance square value: ");
      double dsquare = (385300/intensity);
      ...
      Serial.println(SerialData +"L");
      }
      else{Serial.println(SerialData);}
  // Show Values
// Serial.print("X Value: ");
//  Serial.println(sum_x/100 );//subtract magnetic feild here
//  Serial.print("Y Value: ");
//  Serial.println(sum_y/100);
//  Serial.print("Z Value: ");
//  Serial.println(sum_z/100);
//  Serial.println();
